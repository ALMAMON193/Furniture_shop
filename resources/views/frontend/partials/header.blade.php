                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-md-end">
                        <div class="lng_dropdown">
                            <select name="countries" class="custome_select">
                                <option value='en' data-image="frontend/images/eng.png" data-title="English">English
                                </option>
                                <option value='fn' data-image="frontend/images/fn.png" data-title="France">France
                                </option>
                                <option value='us' data-image="frontend/images/us.png" data-title="United States">
                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="frontend/images/menu_banner7.jpg" alt="menu_banner1">
                                                ...
                                                <div class="header-banner2">
                                                    <img src="frontend/images/menu_banner8.jpg" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Top Laptops</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="frontend/images/menu_banner6.jpg"
                                                            alt="menu_banner"></a>
                                                </div>
                                            </li>
                                        </ul>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="frontend/images/menu_banner9.jpg"
                                                            alt="menu_banner"></a>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="d-lg-flex menu_banners row g-3 px-3">
                                                ...
                                                <div class="header-banner">
                                                    <div class="sale-banner">
                                                        <a class="hover_effect1" href="#">
                                                            <img src="frontend/images/shop_banner_img7.jpg"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="header-banner">
                                                    <div class="sale-banner">
                                                        <a class="hover_effect1" href="#">
                                                            <img src="frontend/images/shop_banner_img8.jpg"
                                                    ...
                                                    <div class="header_banner_content">
                                                        <div class="shop_banner">
                                                            <div class="banner_img overlay_bg_40">
                                                                <img src="frontend/images/shop_banner4.jpg"
                                                                    alt="shop_banner2" />
                                                            </div>
                                                            <div class="shop_bn_content">
                                                                <h6 class="text-uppercase shop_subtitle">New Collection
                                                                </h6>
