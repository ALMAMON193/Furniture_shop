...
<!-- Mirrored from themesbrand.com/velzon/html/master/forms-select2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Nov 2024 15:58:40 GMT -->
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0 card-title">Basic Select2</h5>
                                </div>
                                <div class="card-body">
                                    <p class="text-muted">Use <code>js-example-basic-single</code>,
                                        <code>js-example-basic-multiple</code>, <code>js-example-data-array</code>,
                                        <code>js-example-templating</code>, <code>select-flag-templating</code>, class
                                        to show select2 example.</p>
                                    <div class="row g-4">
                                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0 card-title">Disabling a Select2 Control</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="gap-3 vstack">
                                        ...
                                        <select class="js-example-disabled-multi" name="states[]"
                                            multiple="multiple">
                                            <optgroup label="UK">
                                                <option value="London">London</option>
                                                <option value="Manchester" selected>Manchester</option>
...
<!-- Mirrored from themesbrand.com/velzon/html/master/forms-select2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Nov 2024 15:58:41 GMT -->
